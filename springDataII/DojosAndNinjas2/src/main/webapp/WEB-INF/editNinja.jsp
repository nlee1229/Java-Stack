...
<body>
	...
	<form:form action="/editNinja/${ninja.id}" method="post" modelAttribute = "Ninja">
		...
		<form:input path="firstName" value="${ninja.firstName}"/>
		
	<div>
		<p>Last Name</p>
		<form:label path="lastName"></form:label>
		<form:errors path="lastName"></form:errors>
		<form:input path="lastName" value="${ninja.lastName}"/>
	</div>
	...
	<div>
		...
		<form:input path="age" value="${ninja.age}"/>
	</div>
	
	
	<form:select path="dojo">
		<option value="" disabled selected>Pick Dojo</option>
