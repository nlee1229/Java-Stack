package com.nicholas.languages.models;
...
public class Language {
	...
	public Language(Long id,
			...
			@Size(min = 2, max = 20, message = "Creator must be between 2 and 20 characters.") String creator,
			@Size(min = 1, max = 20, message = "Version must be between 1 and 20 characters.") String currentVersion,
